        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <p className="text-slate-400 text-lg leading-relaxed mb-12">
              Whether you have questions about the platform, need a custom snapshot, or want to discuss a strategic partnership—our True Blue Aussie team has got it going on and we're ready to back you all the way.
            </p>
            ...
            {isSubmitted ? (
              ...
              <div className="space-y-4">
                <div className="text-center mb-8">
                  <h3 className="text-2xl md:text-3xl font-black text-white uppercase tracking-tight">Activate Your 24/7 AI Team</h3>
